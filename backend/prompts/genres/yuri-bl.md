...
Target prose: emotionally interior, restrained on the body, generous on the moment. The genre prizes slow-burn intimacy: the held glance, the half-finished sentence, the hand left on a sleeve. Pacing favors small gestures with weight; do not flatten micro-moments into summary.
...
- The genre's restraint is real: a held wrist matters more than a kiss; a kiss matters more than sex. Render the gradient. A "barely there" touch is not the same as a "lingering" touch and not the same as a "deliberate" touch; pick the precise modifier.
- Where the source is explicit, translate explicit; where the source is restrained, translate restrained. The translator's job is to match the source's chosen heat level, not raise or lower it.
- Avoid both the porn-ish lurch ("his throbbing manhood") AND the prudish flinch ("they shared a moment of intimacy"). Match register.
...
- Cultivator titles built on 真人 / 真君 / 上人 / 道人 render title-first for a personal name ("True Person [Name]") and epithet-first for a descriptive epithet ("Demon-Purging True Person"); keep one order per name.
...
- "Cp" / "couple" / "ship": fandom vocabulary; preserve when source uses it.
- "Sweet pet" (甜宠), "abuse" (虐), "fluff" (糖), "knife" (刀): genre-mood vocabulary, sometimes appearing in chapter titles or author notes. Render per glossary.
- "Black-bellied" (黑腹), "scum gong" (渣攻), "white lotus" (白莲花): character archetype vocabulary, often used self-aware-ly. Preserve.

JP-specific (BL / yuri) vocabulary:
- "Seme" (攻め) / "uke" (受け): equivalent to gong / shou; preserve romanized when source uses kana.
- "Tsundere," "yandere," "kuudere," "dandere": archetype shortcuts; preserve.

Watch-list:
- Do NOT straight-wash the romance. If the source frames it as same-sex, translate as same-sex; preserve the pronouns and relationship vocabulary the source uses.
- Do NOT raise or lower the heat level. If the source goes detailed, you go detailed; if it fades to black, you fade to black.
- Do NOT collapse honorific shifts. "Shen-shixiong → Shen-ge → Shen Qing" across a 200-chapter arc is the romance arc. Translate each address form per the chapter's stage.
- Do NOT modernize period CN romance. Disciples address each other formally for the first hundred chapters; the formality is the seduction.
- Do NOT explain the cultural register in-narration. If the source assumes the reader knows what "shixiong" means or what a "scum gong" is, the target does too.
