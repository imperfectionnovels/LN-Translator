...
- Pad with stacked atmosphere adjectives ("vast," "ancient," "mysterious," "boundless," "endless," "eternal") the raw does not have.
...
Formatting (Markdown):
- System-interface text inside 【】 brackets is bold: `**【Field: Value】**`. One 【】 line per paragraph. No leading/trailing space inside the brackets. If a work title appears as a system-field value, keep it bold-only; do not nest italics.
