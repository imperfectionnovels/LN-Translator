/* reader-quality.js - per-chapter quality badge (cockpit).
 *
 ...
 * observer hits and fixup churn. Data: GET /api/novels/{id}/chapters/{n}/quality
 * (services/quality_dashboard). Deeper triage (the QA observations panel,
 * learn-from-edits) lives in the CAT editor since Phase 6; the popover links
 * there.
 */
...
// Fetch + paint the badge for a chapter (done chapters only; a slow response
// from a previous chapter never paints over the current one).
