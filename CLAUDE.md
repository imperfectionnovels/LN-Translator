...
4. Pure text fixups (`services/text_fixups.py`): `strip_leading_title_line`, `enforce_locked_term_casing`, `enforce_stem_branch_casing`, `enforce_em_dash`, `enforce_spaced_hyphen_dash`, `enforce_brackets`.
...
- `pytest backend/tests`. Currently 1464 tests.
